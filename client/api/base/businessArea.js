...
const BusinessArea = [
  ...
  { code: "1114103", description: "Manutenção - Mozal - Reduction - Pot Cut Out" },
  { code: "1114104", description: "Manutenção - Mozal - Reduction - Bus Bar Repair" },
  { code: "1114105", description: "Manutenção - Mozal - Reduciton - Connectors" },
  { code: "1114106", description: "Manutenção - Mozal - Reduciton - Global Change" },
  { code: "11141103", description: "1111" },
  { code: "1114201", description: "Manutenção - Mozal - Carbon - Bake Furnace" },
  { code: "1114202", description: "Manutenção - Mozal - Carbon - Rodding Shop" },
  { code: "1114203", description: "Manutenção - Mozal - Carbon - Bath Plant" },
  { code: "1114204", description: "Manutenção - Mozal - Carbon - Past Plant" },
  { code: "1114205", description: "Manutenção - Mozal - Carbon - Roding Shop Rehab." },
  { code: "11143", description: "Manutenção - Mozal - Cast House" },
  { code: "1114401", description: "Manutenção - Mozal - Projectos de Engenharia" },
  { code: "11145011", description: "Manutenção Industrial - Kenmare - Moma - Mining" },
  {
    code: "11145012",
  ...
  { code: "1114509", description: "Manutenção Mecânica - Mac Engineering & Service" },
  { code: "1114510", description: "Manutenção Mecânica - Alistair Services" },
  { code: "1114511", description: "Manutenção Mecânica - Tsumelene Sociedade U. Lda" },
  ...
  { code: "111614", description: "Direcção - G - Saude, Segurança e Meio Ambiente" },
  { code: "111615", description: "Direcção - G - Concelho de Administração" },
  { code: "111621", description: "Direcção - FE - Finanças" },
  { code: "111622", description: "Direcção - FE - Estratégia e Desenvolvimento" },
  { code: "111631", description: "Direcção - RH - Recrutamento e Desenvolvimento" },
  ...
  { code: "111712", description: "Refractários - Mozal -Carbon-Bake Furnance(ABF)" },
  { code: "111713", description: "Refractários - Mozal - Carbon - Outros serviços" },
  { code: "111721", description: "Refractários - Mozal - Reduction - DE-Lining Shop" },
  { code: "111722", description: "Refractários - Mozal - Reduction - Lining Shop" },
  { code: "111723", description: "Refractários - Mozal - Reduction - Sealing Shop" },
  { code: "111724", description: "Refractários - Mozal - Reduction - Ladle Workshop" },
  ...
  { code: "111732", description: "Refractários - Mozal - Reduction - Basement Clean" },
  { code: "111733", description: "Refractários - Mozal - T&L - Cleaning" },
  { code: "111734", description: "Refractários - Mozal - Cast House - Lancing" },
